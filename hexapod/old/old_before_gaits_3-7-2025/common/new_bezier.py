...
def de_casteljau(points, t):
    """ Compute a single point De Casteljau's algorithm"""
...
def bezier_curve(points, num_points=100):
    """ Generate the full Bezier curve using De Casteljau's"""
...
if __name__ in "__main__":
    control_points = [
        ...
        np.array([0.2, 0.1, 0.]), # Lift up
        np.array([0.4, 0.2, 0.2]), # Peak height
        np.array([0.6, 0.1, 0.2]), # Descend
