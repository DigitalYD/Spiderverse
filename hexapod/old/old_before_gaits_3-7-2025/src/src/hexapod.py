...
class Hexapod:
    ...
    def __init__(self, leg_configs, hexapod_configs):
        ...
        self.phase_offsets = {
            "tripod": { "LR": 0, "RM": 0, "LF": 0, "RF": 1, "LM": 1, "RR": 1 },  # Two tripod phases
    ...
    def inverse_kinematics(self, position):
        ...
        for leg in active_legs:
            ...
            # Setup position
            footposition[leg].x = self.legs[leg].cur_pos.x + self.body_position.x + position[0] # self.gait_pos[leg].x
            footposition[leg].y = self.legs[leg].cur_pos.y + self.body_position.y + position[1] # self.gait_pos[leg].y
