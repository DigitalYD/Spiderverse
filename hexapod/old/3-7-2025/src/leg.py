...
class Leg:
    ...
    def inverse_kinematics(self, bodyikposition, footpos):
        ...
        footpos.x += bodyikposition.x
        footpos.y += bodyikposition.y
        footpos.z += bodyikposition.z # Ensure correct Z height
        ...
        # Coxa rotation should be mirrored for left legs
       ...
       # Angle between shoulder-hip line and femur
        ika1 = np.arctan2(coxatoeDist - self._coxa_len, toepos.z)
