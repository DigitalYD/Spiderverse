...
'''
class Servo():
    def __init__(self, index, offset = 0, pca = 0x40, pulse_min = 500, pulse_max = 2500, freq = 60, debug=False):
    

        # Assumes 6 legs, 9 servos each side. starting with 0-8
        self.servo_index = index % 9
    ...
    def angle2pulse(self, kin_angle, reverse,  min_angle=-90, max_angle=120):
        ...
        '''
        if reverse: #Reverse may be a bool?
