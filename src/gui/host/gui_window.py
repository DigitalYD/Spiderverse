...
class MainWindow(QMainWindow):
    ...
    def closeEvent(self, event):
        ...
        # Let the LidarWidget handle its own cleanup
        ...
        # Final ROS shutdown if needed
        try:
            import rclpy
            if rclpy.ok():
                print("Final ROS shutdown")
                rclpy.shutdown()
        except Exception as e:
            print(f"Error during final ROS shutdown: {e}")
            # Continue with application shutdown regardless
