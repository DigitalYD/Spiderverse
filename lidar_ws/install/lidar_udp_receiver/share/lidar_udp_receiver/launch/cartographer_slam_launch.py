...
def generate_launch_description():
    ...
    use_trilateration = LaunchConfiguration('use_trilateration')
    ...
    use_trilateration_arg = DeclareLaunchArgument(
        'use_trilateration',
        default_value='true',
        description='Whether to use trilateration for additional positioning'
    )
    ...
    trilateration_node = Node(
        ...
        parameters=[{
            'frame_id': 'map',
            'position_topic': 'trilateration_pose',
            'odometry_topic': 'trilateration_odom',
        ...
        condition=IfCondition(use_trilateration)
    )
    
    return LaunchDescription([
        cartographer_config_dir_arg,
        configuration_basename_arg,
        use_trilateration_arg,
        cartographer_node,
        occupancy_grid_node,
        trilateration_node,
    ])